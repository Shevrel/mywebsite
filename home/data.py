data = {
    'en': {
        ...
        'projects': [
            {
                'title': "Project 1",
                'description': "A web app developed using Django.",
                'github_link': "https://github.com/example/project1"
            },
            {
                'title': "Project 2",
                'description': "A mobile app built with Kotlin.",
    ...
    'de': {
        ...
        'projects': [
            {
                'title': "Projekt 1",
                'description': "Eine Web-App, die mit Django entwickelt wurde.",
                'github_link': "https://github.com/example/project1"
            },
            {
                'title': "Projekt 2",
                'description': "Eine mobile App, die mit Kotlin entwickelt wurde.",
                'github_link': "https://github.com/example/project2"
            }
        ],
        'contact': {
